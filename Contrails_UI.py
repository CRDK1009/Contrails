...
with col2:
    st.image("contrail.png",width=300)
...
Moscow_alt=st.sidebar.number_input('Moscow',value=15000)
Moscow_hour=st.sidebar.selectbox('Hour at Moscow',range(1,24),index=1)
Minsk_alt=st.sidebar.number_input('Minsk',value=35000)
Minsk_hour=st.sidebar.selectbox('Hour at Minsk',range(1,24),index=2)
Berlin_alt=st.sidebar.number_input('Berlin',value=35000)
Berlin_hour=st.sidebar.selectbox('Hour at Berlin',range(1,24),index=4)
Colgne_alt=st.sidebar.number_input('Cologne',value=35000)
Colgne_hour=st.sidebar.selectbox('Hour at Cologne',range(1,24),index=5)
Lux_alt=st.sidebar.number_input('Luxembourg',value=35000)
Lux_hour=st.sidebar.selectbox('Hour at Luxembourg',range(1,24),index=6)
Reims_alt=st.sidebar.number_input('Reims',value=35000)
Reims_hour=st.sidebar.selectbox('Hour at Reims',range(1,24),index=7)
Paris_alt=st.sidebar.number_input('Paris',value=10000)
Paris_hour=st.sidebar.selectbox('Hour at Paris',range(1,24),index=7)
